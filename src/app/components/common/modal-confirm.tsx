        ...
        <div className="flex min-h-full items-start mt-[220px] justify-center p-4 text-center sm:items-start sm:p-0">
          ...
          >
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                type="button"
                className="inline-flex w-full justify-center rounded-md bg-red-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-buttonPrimaryHover sm:ml-3 sm:w-auto"
                onClick={onConfirm}
              >
                {confirmLabel}
              </button>
